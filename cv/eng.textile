...
!>{width: 200px;}https://s.gravatar.com/avatar/3f63a8bc4eb83620fe4316b3ce2b649b?s=400(Photo)!
...
* Developing frontend using jQuery, Backbone, Highcharts
* Working with different maps sevices APIs
...
* Developing HTML5 mobile application using PhoneGap platform (JavaScript, Objective-C, Java)
